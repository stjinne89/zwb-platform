...
export const COURSES: Record<CourseId, Course> = {
  polder: {
    id: "polder", name: "Polderkoers", subtitle: "Wind op kop. Alles op de sprint.", color: "#b5ef65", length: 10000,
  ...
  ardennen: {
    id: "ardennen", name: "Ardennenjacht", subtitle: "Korte hellingen. Lange adem.", color: "#f5bf76", length: 9000,
  ...
  alpen: {
    id: "alpen", name: "Alpenfinale", subtitle: "Spaar in het dal. Win op de top.", color: "#a8d9ff", length: 7800,
