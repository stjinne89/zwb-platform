...
export default function SegmentHelp() {
  return <article className="mx-auto max-w-3xl space-y-5">
    ...
    <p>De snelste ZWB’er op een segment met minstens drie ZWB’ers krijgt de titel ZWB KOM. Bij een gelijke snelste tijd delen leden de titel. De titels staan op je profiel en op de ledenpagina, onder dezelfde zichtbaarheidsinstelling als je badges. Het dashboard toont KOM’s die in de afgelopen zeven dagen zijn gereden. Een nieuwe rit of wijziging in het klassement werkt binnen enkele minuten door; een record uit een ouder ingelezen rit komt wel op je profiel, maar niet als nieuw op het dashboard.</p>
