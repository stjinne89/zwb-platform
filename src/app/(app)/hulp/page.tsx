...
const GUIDES = [
  {
    ...
    bullets: [
      "Speel via Club → ZWBgame als jezelf tegen maximaal 23 clubgenoten. Kies Polderkoers, Ardennenjacht, Heuvelrug of Alpenfinale: korte parcoursen van 3,5 tot 4 km, opgebouwd uit stukken vlak, tegenwind, klim, afdaling en bevoorrading. Een race duurt ongeveer 4 tot 5 minuten. Bij een klein roster vullen fictieve gasten het peloton aan.",
      "Je rijdt in een van vier standen: Sparen (1), Meerijden (2), Naar voren (3) of Aanvallen (4). Wisselen kan ook met pijltje omhoog en omlaag. Sparen en Meerijden houden je in het wiel, Sparen op een lager tempo. Naar voren brengt je in de wind naar de kop en houdt daar tempo. Aanvallen kost je aanvalsreserve; is die leeg, dan ga je vanzelf terug naar Meerijden. Tik op een renner in het koersoverzicht om diens wiel te volgen.",
      "In het wiel spaar je energie en blijf je bij de groep. Valt er een gat tot 150 meter, dan rijd je dat automatisch dicht op een hoger tempo dat energie kost; met meer renners achter je lukt dat sneller. Laat de renner voor je een gat vallen en ben je sterker, dan rijd je er automatisch omheen. Wie op Meerijden blijft, rijdt mee in het peloton, maar moet voor de finale zelf naar voren. Kopwerk is je gekozen tempo in de wind. Naar voren kost extra inspanning; op steile hellingen verdwijnt het slipstreamvoordeel. Energie, aanvalsreserve en drinken hebben elk invloed op je prestaties. De wind verschilt per race, ook op hetzelfde parcours.",
      "Neem op tijd een gel (E) of bidon (D). Dat vraagt enkele seconden rustiger rijden. Een gel werkt geleidelijk; drinken vult je hydratatie aan. Zakt je hydratatie onder 40, dan word je langzamer. Je begint met twee gels en twee bidons en krijgt er bij de bevoorrading van elk één bij; waar die ligt, staat onder de bediening.",
      ...
      "Draai je telefoon liggend: tijdens de race vult het spel dan het hele scherm, met de standen onder je rechterduim en eten, drinken en kaarten links. Met de knop voor volledig scherm verdwijnt ook de adresbalk; op telefoons die het toestaan draait het beeld mee. De groepenbalk bovenin laat zien hoeveel groepen er rijden, met hun achterstand en waar jij zit. 3D · zuinig verlaagt de grafische belasting. Zonder WebGL blijven koersoverzicht en bediening bruikbaar. Bij een geblokkeerde browseropslag kun je wel spelen, maar niet betrouwbaar bewaren.",
