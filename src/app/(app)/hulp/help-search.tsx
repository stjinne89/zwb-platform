...
const HELP_INDEX: HelpResult[] = [
  ...
  },
  {
    ...
    href: "/hulp#pacing",
    terms: "pacing pacingplan verdeling vermogen w/kg klim klimmen event gran fondo neutralisatie neutraal wagen verouderd doorrekenen reserve afdaling afdalen uitrollen",
  },
  {
    title: "Krachtreeksen",
