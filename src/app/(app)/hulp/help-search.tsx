...
const HELP_INDEX: HelpResult[] = [
  { title: "ZWBgame", text: "Spelregels, eten en drinken, tactiek, bonuskaarten, knechten, deelname en sportgegevens.", href: "/hulp#zwbgame", terms: "game spel wielrennen koers race peloton gel bidon energie tactiek bonuskaart kaarten knecht ploeg dagvorm wind strava intervals spelprofiel toestemming pauzeren hervatten" },
  {
    title: "FTP-test",
    text: "Je trainer plant de test; jij vult de uitslag in en je FTP volgt.",
    href: "/hulp#ftp-test",
    terms:
      "ftp test ramptest ramp 20 minuten twintig minuten drempel vermogen watt meten uitslag testen targetwatts invullen losse test beste minuut intervals eftp corrigeren aanpassen wijzigen verwijderen verkeerd ingevuld fout",
  },
  {
  ...
  },
  {
    ...
    href: "/hulp#watt-wkg",
    terms: "w/kg wkg watt per kilo gewicht vermogen eenheid schakelaar ftp doel",
  },
  {
