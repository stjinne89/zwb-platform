...
const HELP_INDEX: HelpResult[] = [
  {
    ...
    href: "/hulp#ftp-test",
    terms:
      "ftp test ramptest ramp 20 minuten twintig minuten drempel vermogen watt meten uitslag testen targetwatts invullen losse test beste minuut intervals eftp",
  },
  {
