    ...
    <section className="space-y-2">
      {groups.map((g) => (
        <a
          ...
          className="flex items-center justify-between gap-3 rounded-lg border-2 border-green-600/30 bg-green-50/60 p-4 transition hover:border-green-600 hover:bg-green-50 dark:bg-green-950/30 dark:hover:bg-green-950/60"
        >
          <div className="min-w-0 flex-1">
            <p className="flex items-center gap-2 font-medium text-green-900 dark:text-green-100">
              <svg
              ...
              Open {scope === "team" ? "team" : "event"}-WhatsApp
            </p>
